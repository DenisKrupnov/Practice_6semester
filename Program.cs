...
namespace SynergyPractice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Динамический массив для хранения объектов Worker
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                // Создание объекта Worker с использованием конструктора с параметрами
            ...
            // Ввод минимального стажа для фильтрации
            ...
            // Поиск сотрудников со стажем больше указанного
